                    ...
                    <div class="product-content-right">
                        <div class="woocommerce">
                            ...
                            if(isset($_POST['login'])){
                                ...
                                $sql = "select * from taikhoan where email= '$username' and password= '$password'";
                            ...
                            <form id="coupon-collapse-wrap" action="create_gh.php" method="post" class="checkout_coupon collapse">
                            ...
                            <form enctype="multipart/form-data" action="create_gh.php" class="checkout" method="POST" name="checkout">
                                ...
                                <div id="order_review" style="position: relative;">
                                        ...
                                        $tongsl+=$row['soluong'];
                                            ...
                                            <tr class="cart_item">
                                                <td class="product-name">
                                                    <?php echo $row['TENSP'];?> <strong class="product-quantity"> x<?php echo $row['soluong'];?></strong> </td>
                                                <td class="product-total">
                                                    <span class="amount"><?php echo number_format ($row['GIABAN'] * $row['soluong'])?>đ</span> </td>
                                            </tr>
                                            <?php endforeach ?>
                                        </tbody>
                                        <tfoot>
                                            ...
                                            <tr class="cart-subtotal">
                                                <th>Cart Subtotal</th>
                                                <td><span class="amount"><?php echo number_format ($tong);?>đ</span>
                                                </td>
                                            </tr>
                                    ...
                                    <div id="payment">
                                        <ul class="payment_methods methods" >
                                            ...
                                            <li class="payment_method_paypal">
                                                <input type="radio" data-order_button_text="Proceed to PayPal" value="momo" name="payment_method" class="input-radio" id="payment_method_paypal">
                                                <label for="payment_method_paypal">Ví MOMO,Viettelpay,Vnptpay... 
                                                </label>
                                                <div style="display:none;" class="payment_box payment_method_paypal">
                                                    <p>Ví MOMO,Viettelpay,Vnptpay...</p>
                                                </div>
                                            </li>
                                        </ul>
                                        <div class="form-row place-order">
                                        <input type ="hidden" value="<?php echo $tong;?>" name ="tongtien"/>
                                        <input type ="hidden" value="<?php echo $tongsl;?>" name ="tongsl"/>
